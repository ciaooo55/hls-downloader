...
- Candidate #387 on the HLS-validated connector head was intentionally superseded by the subsequent migration/FTP/recognition source-hardening commits; its cancellation is not a product failure. Subsequent recognition and harvest hardening remains isolated to this branch and does not change the release-readiness boundary.
