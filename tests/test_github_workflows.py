...
def test_release_builds_only_windows_assets_and_publishes_tags():
    ...
    assert 'default: "3.0.9"' in workflow
...
def test_readme_documents_windows_release_assets():
    ...
    assert "HLSDownloader-v3.0.9-Windows-x64-Setup.exe" in readme
    assert "HLSDownloader-v3.0.9-Windows-x64-Portable.zip" in readme
