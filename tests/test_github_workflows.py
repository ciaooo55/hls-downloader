...
def test_release_builds_only_windows_assets_and_publishes_tags():
    ...
    assert 'default: "3.0.14"' in workflow
    ...
    assert "$prefix-Firefox-No-Web-UI-Source.zip" in workflow
...
def test_readme_documents_windows_release_assets():
    ...
    assert "HLSDownloader-v3.0.14-Windows-x64-Setup.exe" in readme
    assert "HLSDownloader-v3.0.14-Windows-x64-Portable.zip" in readme
    assert "m3u8-sniffer.user.js" not in readme
    assert "HLSDownloader-v3.0.14-Firefox-Web-UI-Unsigned.zip" in readme
    assert "HLSDownloader-v3.0.14-Firefox-Web-UI-Source.zip" in readme
    assert "HLSDownloader-v3.0.14-Firefox-No-Web-UI-Unsigned.zip" in readme
    assert "HLSDownloader-v3.0.14-Firefox-No-Web-UI-Source.zip" in readme
