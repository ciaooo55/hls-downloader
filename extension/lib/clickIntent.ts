...
const DOWNLOAD_URL_HINT = /\.(?:m3u8|mpd|mp4|webm|mkv|mov|avi|m4a|mp3|flac|wav|torrent|zip|7z|rar|tar|gz|bz2|xz|iso|exe|msi|apk|dmg|pkg|deb|rpm|pdf|epub|docx?|xlsx?|pptx?)(?:$|[?#])|\/(?:downloads?|attachments?|exports?)(?:[/?#]|$)|[?&](?:download|attachment|disposition|filename|export)=/i
