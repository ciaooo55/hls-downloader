...
4. `powershell -ExecutionPolicy Bypass -File scripts/build_v6.ps1 -Version 6.0.1`
5. `powershell -ExecutionPolicy Bypass -File scripts/smoke_v6_package.ps1 -ArchivePath release/HLSDownloader-v6.0.1-Windows-x64-Portable.zip`
...
- HLS TS concat, fMP4 local playlist, AES-128, LL-HLS PART, live stop; Setup/Portable bundle pinned ffmpeg/ffprobe and libmpv-2.dll
