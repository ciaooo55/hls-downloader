...
$targetProcessNames = @("HLSDownloader", "HLSDownloaderCore", "HLSNativeShell", "hls-native-shell")
...
function Test-ApplicationFilesWritable {
    ...
    foreach ($name in @("HLSDownloader.exe", "HLSDownloaderCore.exe", "HLSNativeShell.exe")) {
